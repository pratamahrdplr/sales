  ...
  <div class="x_panel">
    ...
    <div class="x_content">
      ...
      <div class="btn-group">
        ...
        <a class="btn btn-warning" href="?page=data_sisa_s">(S) Kontrak PT Lain </a>
      ...
      <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
        ...
        <tbody>
          ...
          $kontak_query = mysql_query("select * from tb_kontak_all where id_user = '$session_user'  AND report_kontak = 'S' and status_kontak ='telah dihubungi'") or die(mysql_error());
