         ...
         <div class="col-md-12 col-sm-12 col-xs-12">
           ...
           <script language="javascript">
             function container(print_c) {
               var headstr = "<html><head><title>Data Base telah di telepon</title></head><body> <h4> PT Pratama Langgeng Raya </h4>Database yang telah di telepon marketing dari Tanggal : <?php echo $tgl_awal ?> Sampai dengan tanggal : <?php echo $tgl_akhir ?>";
               var footstr = "</body>";
