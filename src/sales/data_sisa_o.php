...
<div class="btn-group">
                        ...
                        <a class="btn btn-warning" href="?page=data_sisa_o">(O) Kalah Harga </a>
...
$kontak_query = mysql_query("select * from tb_kontak_all where id_user = '$session_user'  AND  status_kontak ='telah dihubungi' AND report_kontak = 'O' ")or die(mysql_error());
