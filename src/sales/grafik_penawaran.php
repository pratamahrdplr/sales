...
{
var headstr = "<html><head><title>Data Penawaran Terkirim</title></head><body> <h4> PT Sinar Bacan Khatulistiwa </h4>Data Penawaran Terkirim dari Tanggal : <?php echo $tgl_awal ?> Sampai dengan tanggal : <?php echo $tgl_akhir ?>";
var footstr = "</body>";
