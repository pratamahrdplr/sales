 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
   ...
   <script language="javascript">
     function container(container) {
       var headstr = "<html><head><title>Data Penawaran Terkirim</title></head><body> <h4> PT Pratama Langgeng Raya </h4>Data Penawaran Gagal dari Tanggal : <?php echo $tgl_awal ?> Sampai dengan tanggal : <?php echo $tgl_akhir ?>";
       var footstr = "</body>";
